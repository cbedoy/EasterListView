...
public class EasterEggView extends ListView{

    private static final float PULL_RESISTANCE                 = 1.0f;
    ...
    public EasterEggView(Context context, AttributeSet attrs, int defStyle){
